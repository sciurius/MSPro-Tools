...
CREATE TABLE SourceType(Id INTEGER PRIMARY KEY,Type VARCHAR(255), SortBy INTEGER DEFAULT 1);
CREATE TABLE SourceTypeSongs(Id INTEGER PRIMARY KEY,SourceTypeId INTEGER,SongId INTEGER);
CREATE TABLE CustomGroup(Id INTEGER PRIMARY KEY,Name VARCHAR(255), SortBy INTEGER DEFAULT 1);
CREATE TABLE CustomGroupSongs(Id INTEGER PRIMARY KEY,GroupId INTEGER,SongId INTEGER);
CREATE TABLE Composer(Id INTEGER PRIMARY KEY,Name VARCHAR(255), SortBy INTEGER DEFAULT 1);
...
CREATE TABLE Books(Id INTEGER PRIMARY KEY,Title VARCHAR(255), SortBy INTEGER DEFAULT 1);
CREATE TABLE BookSongs(Id INTEGER PRIMARY KEY,BookId INTEGER,SongId INTEGER);
CREATE TABLE Artists(Id INTEGER PRIMARY KEY,Name VARCHAR(255), SortBy INTEGER DEFAULT 1);
CREATE TABLE ArtistsSongs(Id INTEGER PRIMARY KEY,ArtistId INTEGER,SongId INTEGER);
CREATE TABLE Genres(Id INTEGER PRIMARY KEY,Type VARCHAR(255), SortBy INTEGER DEFAULT 1);
CREATE TABLE GenresSongs(Id INTEGER PRIMARY KEY,GenreId INTEGER,SongId INTEGER);
CREATE TABLE Key(Id INTEGER PRIMARY KEY,Name VARCHAR(255), SortBy INTEGER DEFAULT 1);
CREATE TABLE KeySongs(Id INTEGER PRIMARY KEY,KeyId INTEGER,SongId INTEGER);
CREATE TABLE Signature(Id INTEGER PRIMARY KEY,Name VARCHAR(255), SortBy INTEGER DEFAULT 1);
CREATE TABLE SignatureSongs(Id INTEGER PRIMARY KEY,SignatureId INTEGER,SongId INTEGER);
CREATE TABLE Years(Id INTEGER PRIMARY KEY,Name VARCHAR(255), SortBy INTEGER DEFAULT 1);
...
CREATE TABLE ExtraData(Id INTEGER PRIMARY KEY,SongId INTEGER,Notes VARCHAR(1024),Tag VARCHAR(255),AutoStartAudio INTEGER);
CREATE TABLE Bookmarks(Id INTEGER PRIMARY KEY,SongId INTEGER,Name VARCHAR(255),PageNum INTEGER,ShowInLibrary INTEGER);
CREATE TABLE Recent(Id INTEGER PRIMARY KEY,Song INTEGER,RecentType INTEGER DEFAULT 0);
CREATE TABLE Setlists(Id INTEGER PRIMARY KEY,Name VARCHAR(255),LastPage INTEGER,LastIndex INTEGER,SortBy INTEGER);
...
CREATE TABLE Collections(Id INTEGER PRIMARY KEY,Name VARCHAR(255), SortBy INTEGER DEFAULT 1);
