...
CREATE TABLE SourceType(Id INTEGER PRIMARY KEY,Type VARCHAR(255));
CREATE TABLE SourceTypeSongs(Id INTEGER PRIMARY KEY,SourceTypeId INTEGER,SongId INTEGER);
CREATE TABLE CustomGroup(Id INTEGER PRIMARY KEY,Name VARCHAR(255));
...
CREATE TABLE Books(Id INTEGER PRIMARY KEY,Title VARCHAR(255));
CREATE TABLE BookSongs(Id INTEGER PRIMARY KEY,BookId INTEGER,SongId INTEGER);
CREATE TABLE Artists(Id INTEGER PRIMARY KEY,Name VARCHAR(255));
CREATE TABLE ArtistsSongs(Id INTEGER PRIMARY KEY,ArtistId INTEGER,SongId INTEGER);
CREATE TABLE Genres(Id INTEGER PRIMARY KEY,Type VARCHAR(255));
...
CREATE TABLE Signature(Id INTEGER PRIMARY KEY,Name VARCHAR(255));
CREATE TABLE SignatureSongs(Id INTEGER PRIMARY KEY,SignatureId INTEGER,SongId INTEGER);
CREATE TABLE Years(Id INTEGER PRIMARY KEY,Name VARCHAR(255));
...
CREATE TABLE Collections(Id INTEGER PRIMARY KEY,Name VARCHAR(255));
